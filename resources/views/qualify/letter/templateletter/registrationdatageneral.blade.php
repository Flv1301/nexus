...
<div class="content layout-fixed">
        <div class="container">
                ...
                <div class="">
                   <div class="col-12">
                       <p class="text-left ">OFÍCIO Nº {{$number}}/2023/NIP/CYBER-LAB</p>
                           ...
                           <li class="text-justify">A possível renitência em cumprir esta requisição poderá gerar responsabilidade penal em face da prática dos crimes de prevaricação e/ou desobediência com infração das disposições legais, como bem destacam os arts. 319 e 330, do Código Penal.</li>
                            ...
                            <p>
                                <strong class="text-center">
                                    <img width="400px" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images'. DIRECTORY_SEPARATOR .'assinaturadpc.jpeg'))) }}" class="rounded text-center align-content-center" alt="...">
                               </strong>
...
{{--<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-print-css/css/bootstrap-print.min.css" media="print">--}}
{{--@php--}}
{{--$a = "a";--}}
{{--dd($a);--}}
{{--@endphp--}}
